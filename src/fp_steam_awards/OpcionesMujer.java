...
public class OpcionesMujer extends JPanel {
	...
	public OpcionesMujer() {
		...
		opc1 =new JRadioButton("Dietética");
		opc2 =new JRadioButton("Educación Infantil");
		opc3 =new JRadioButton("Estilismo y Dirección de Peluquería");
		opc4 =new JRadioButton("Integración Social");
		opc5 =new JRadioButton("Comercio Internacional");
		opc6 =new JRadioButton("Diseño y Amueblamiento");
		opc7 =new JRadioButton("Guía, Información y Asistencias Turísticas");
