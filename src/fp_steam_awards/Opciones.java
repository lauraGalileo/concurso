...
public class Opciones extends JPanel {
	...
	public Opciones() {
		...
		opc9 =new JRadioButton("Dietética");
		opc10 =new JRadioButton("Educación Infantil");
		opc11 =new JRadioButton("Estilismo y Dirección de Peluquería");
		opc12 =new JRadioButton("Integración Social");
		opc13 =new JRadioButton("Comercio Internacional");
		opc14 =new JRadioButton("Diseño y Amueblamiento");
		opc15 =new JRadioButton("Guía, Información y Asistencias Turísticas");
